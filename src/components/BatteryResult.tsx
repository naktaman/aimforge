      ...
      const dna = await invoke<AimDnaProfile>('compute_aim_dna_cmd', {
        params: {
          input: {
            ...
            /* Rust ScenarioScores: #[serde(rename_all = "camelCase")] — camelCase 키 필수 */
            scenarioScores: {
              flick: batteryResult.scores.flick ?? null,
              tracking: batteryResult.scores.tracking ?? null,
              circularTracking: batteryResult.scores.circular_tracking ?? null,
              stochasticTracking: batteryResult.scores.stochastic_tracking ?? null,
              counterStrafeFlick: batteryResult.scores.counter_strafe_flick ?? null,
              microFlick: batteryResult.scores.micro_flick ?? null,
              zoomComposite: batteryResult.scores.zoom_composite ?? null,
            },
          },
        },
      });
