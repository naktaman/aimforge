...
type ParamsAction = { type: 'SET_FIELD'; field: keyof ScenarioParamsState; value: ScenarioParamsState[keyof ScenarioParamsState] };

const initialParamsState: ScenarioParamsState = {
...
function paramsReducer(state: ScenarioParamsState, action: ParamsAction): ScenarioParamsState {
