...
export const BATTERY_PRESETS: Record<BatteryPreset, BatteryWeights> = {
  ...
  TACTICAL: {
    flick: 0.25,
    tracking: 0.10,
    circularTracking: 0.05,
    stochasticTracking: 0.05,
    counterStrafeFlick: 0.25,
    microFlick: 0.15,
    zoomComposite: 0.15,
  },
  ...
  MOVEMENT: {
    flick: 0.10,
    tracking: 0.15,
    circularTracking: 0.15,
    stochasticTracking: 0.15,
    counterStrafeFlick: 0.10,
    microFlick: 0.20,
    zoomComposite: 0.15,
  },
  ...
  CUSTOM: {
    flick: 0.15,
    tracking: 0.15,
    circularTracking: 0.10,
    stochasticTracking: 0.10,
    counterStrafeFlick: 0.15,
    microFlick: 0.15,
    zoomComposite: 0.20,
  },
};
